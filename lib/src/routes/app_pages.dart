...
import 'package:design_patterns/src/patterns/prototype/page/prototype_page.dart';
import 'package:get/get.dart';

import '../patterns/builder/build_page/build_page_bindings.dart';
import '../patterns/prototype/page/prototype_bindings.dart';
...
class AppPages {
  ...
  static final routes = [
    ...
    GetPage(
      ...
      binding: BuildPageBindings(),
    ),
    GetPage(
      name: Routes.prototype,
      page: () => const PrototypePage(),
      binding: PrototypeBindings(),
    ),
  ];
}
